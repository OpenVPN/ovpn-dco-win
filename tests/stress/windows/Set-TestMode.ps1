...
.DESCRIPTION
    -Arm sets the checked-build AEAD usage cap so epoch keys rotate about every ninety
    thousand packets, and turns on Driver Verifier special pool plus deadlock detection.
